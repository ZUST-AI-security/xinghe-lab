...
const LabSection = () => (
  ...
  >
    <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
      ...
      <Title level={2} style={{ color: '#ffffff', margin: '0 0 20px' }}>
        浙江科技大学
        <br />
      ...
      <Row gutter={[24, 24]} justify="center">
        {[
          ...
          <Col key={item.label} xs={12} sm={6}>
            ...
            >
              <div style={{ fontSize: 24, color: item.color, marginBottom: 8 }}>
                {item.icon}
              </div>
              <Text style={{ color: 'rgba(226,232,240,0.85)', fontSize: 13, fontWeight: 600 }}>
                {item.label}
              </Text>
            </div>
          </Col>
...
const CTASection = ({ onLogin, onRegister }) => (
  ...
  >
    <div style={{ maxWidth: 600, margin: '0 auto' }}>
      ...
      <Paragraph style={{ color: '#64748b', fontSize: 15, margin: '0 0 36px', lineHeight: 1.8 }}>
